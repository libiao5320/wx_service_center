...
public class DredpacketsServiceImpl extends BaseServiceImpl<Dredpackets> implements DredpacketsService {
    ...
    public List<Dredpackets> listWithPage(Dredpackets t) throws Exception {
        return this.dredpacketsMapper.listWithPage(t);
    }
    ...
    public long getRandomAmount( Dredpackets dredpackets )
    {
        ...
        result =  hongBaoAlgorithm.generate(dredpackets.getAmount(),dredpackets.getQuantity(),dredpackets.getMaxAmount() , dredpackets.getMinAmount());
...
//              long temp = max - sqrt(nextLong(range2));
	...
	public List pListWithPageAndCondition(Dredpackets paramRedpackets) {
	...
	public long saveRedpacketsStore(DredpacketsStore redpacketsStore) {
		return this.dredpacketsMapper.saveRedpacketsStore(redpacketsStore);
	}

	public Long saveRedpacketsGroupClass(DredpacketsGroupbuy dg) {
		return this.dredpacketsMapper.saveRedpacketsGroupClass(dg);
	}

	public List<Map> queryStoreByRedpacketsId(Long id) {
		return this.dredpacketsMapper.queryStoreByRedpacketsId(id);
	}

	public Long updateRedpacketsStore(DredpacketsStore redpacketsStore) {
		return this.dredpacketsMapper.updateRedpacketsStore(redpacketsStore);
	}

	public Long deleteRedpacketsGroupClassByRedId(Long id) {
		return this.dredpacketsMapper.deleteRedpacketsGroupClassByRedId(id);
	}

	public long updateRedpackets(Dredpackets redpackets) {
		return this.dredpacketsMapper.updateRedpackets(redpackets);
	}

	public List<Map> queryGroupClassByRedpacketsId(Long id) {
		return this.dredpacketsMapper.queryGroupClassByRedpacketsId(id);
	}
}