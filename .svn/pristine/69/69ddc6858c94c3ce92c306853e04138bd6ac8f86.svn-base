...
public class Dgoods extends BaseEntity implements java.io.Serializable {
	...
	private String isDiyText;//是否使用自定义文本框
	private int xfqYxqValues;//消费券有效期基础值
    ...
    private DgroupbuyClass classOne;
    private DgroupbuyClass classTwo;
    private List<GoodImg> goodImgs;
	
    private java.lang.String text;//文本详情
    ...
    public DgroupbuyClass getClassOne() {
        return classOne;
    }

    public void setClassOne(DgroupbuyClass classOne) {
        this.classOne = classOne;
    }

    public DgroupbuyClass getClassTwo() {
        return classTwo;
    }

    public void setClassTwo(DgroupbuyClass classTwo) {
        this.classTwo = classTwo;
    }

	public int getXfqYxqValues() {
		return xfqYxqValues;
	}

	public void setXfqYxqValues(int xfqYxqValues) {
		this.xfqYxqValues = xfqYxqValues;
	}

    public List<GoodImg> getGoodImgs() {
        return goodImgs;
    }

    public void setGoodImgs(List<GoodImg> goodImgs) {
