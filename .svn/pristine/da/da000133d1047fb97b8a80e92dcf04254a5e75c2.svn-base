...
public class Dmember extends BaseEntity implements java.io.Serializable{
	...
	public static final String ALTAS_VIP_RANK_ID="会员等级";
	...
	private String availablePredepositDollor;
	private Long freezePredeposit;
	private String freezePredepositDollor;
	private Long availableRcBalance;
	private String availableRcBalanceDollor;
	private Long freezeRcBalance;
	private String freezeRcBalanceDollor;
	...
	private Dvip dvip;
	private String rlAcc;
	private String rlAccPasswd;
	private String rlVoip;
	private String rlVoipPasswd;

	private String memberStartTime;	//开始时间
	private String memberEndTime;	//结束时间
	private String orderBy;	//排序
	
	private Darea city;	//所在城市
	
	private String balance;//账户余额----(预存款可用金额+预存款冻结金额)
	
	private String storedDollar;//储值金额
	
	private Long savingsAmount;
	
	private String savingsAmountDollar = "0.00";
	
	public String getSavingsAmountDollar() {
		if(savingsAmount != null)
			savingsAmountDollar = MoneyUtil.getCentToDollar(savingsAmount);
		return savingsAmountDollar;
	}

	public void setSavingsAmountDollar(String savingsAmountDollar) {
		this.savingsAmountDollar = savingsAmountDollar;
	}
	...
	public String getStoredDollar() {
		return storedDollar;
	}

	public void setStoredDollar(String storedDollar) {
		this.storedDollar = storedDollar;
	}

	public String getBalance() {
		if(availablePredeposit != null && freezePredeposit != null)
		balance = MoneyUtil.getCentToDollar(availablePredeposit+freezePredeposit);
		return balance;
	}
	...
	public Darea getCity() {
		return city;
	}

	public void setCity(Darea city) {
		this.city = city;
	}
	...
	public void setAvailablePredeposit(java.lang.Long value) {
		...
		this.setAvailablePredepositDollor(MoneyUtil.getCentToDollar(value));
	}
	...
	public void setFreezePredeposit(java.lang.Long value) {
		...
		this.setFreezePredepositDollor(MoneyUtil.getCentToDollar(value));
	}
	...
	public void setAvailableRcBalance(java.lang.Long value) {
		...
		this.setAvailableRcBalanceDollor(MoneyUtil.getCentToDollar(value));
	}
	...
	public void setFreezeRcBalance(java.lang.Long value) {
		...
		this.setFreezeRcBalanceDollor(MoneyUtil.getCentToDollar(value));
	}
	...
	public String getFreezeRcBalanceDollor() {
		return freezeRcBalanceDollor;
	}

	public void setFreezeRcBalanceDollor(String freezeRcBalanceDollor) {
		this.freezeRcBalanceDollor = freezeRcBalanceDollor;
	}

	public String getAvailableRcBalanceDollor() {
		return availableRcBalanceDollor;
	}

	public void setAvailableRcBalanceDollor(String availableRcBalanceDollor) {
		this.availableRcBalanceDollor = availableRcBalanceDollor;
	}

	public String getFreezePredepositDollor() {
		return freezePredepositDollor;
	}

	public void setFreezePredepositDollor(String freezePredepositDollor) {
		this.freezePredepositDollor = freezePredepositDollor;
	}

	public String getAvailablePredepositDollor() {
		return availablePredepositDollor;
	}

	public void setAvailablePredepositDollor(String availablePredepositDollor) {
		this.availablePredepositDollor = availablePredepositDollor;
	}
	...
	public void setDvip(Dvip dvip) {
		this.dvip = dvip;
	}

	public String getRlAcc() {
		return rlAcc;
	}

	public void setRlAcc(String rlAcc) {
		this.rlAcc = rlAcc;
	}

	public String getRlAccPasswd() {
		return rlAccPasswd;
	}

	public void setRlAccPasswd(String rlAccPasswd) {
		this.rlAccPasswd = rlAccPasswd;
	}
	...
	public void setRlVoip(String rlVoip) {
		this.rlVoip = rlVoip;
	}

	public String getRlVoipPasswd() {
		return rlVoipPasswd;
	}

	public void setRlVoipPasswd(String rlVoipPasswd) {
		this.rlVoipPasswd = rlVoipPasswd;
	}
